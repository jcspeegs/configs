...
buildPythonPackage rec {
  ...
  meta = with lib; {
    ...
    description = "iwlib is a package for interfacing with iwlib, providing an implementation to the wireless tools in Linux";
    changelog = "https://github.com/nhoad/python-iwlib#change-history";
    maintainers = with mainainers; [ jcspeegs ];
